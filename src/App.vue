<template>
  <v-app id="vcrm">
    ...
    <template v-if="signedIn">
      <v-navigation-drawer class="sidebar blue lighten-5" mini-variant-width="70" width="250" light :mini-variant.sync="mini" v-model="drawer" app>
        <v-list class="pa-0">
          <v-list-item tag="div">
            <v-list-item-action>
              <v-img max-width="2.75em" class="avatar" src="@/assets/avatar0.png" />
            </v-list-item-action>
            <v-list-item-content>
...
<style scoped>
  ...
  .v-card__title .v-btn__content i{
